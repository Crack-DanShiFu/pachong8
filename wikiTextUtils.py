...
# with open('result/' + wikiFiles[250]) as f:
#     ls = json.load(f)
#     article = ls[0]['*']
#     article = getContent(article)
#     a = textstat.flesch_reading_ease(article)
#     b = textstat.coleman_liau_index(article)
#     c = textstat.difficult_words(article)
#     print(a)
#     print(b)
#     print(c)
#     d=pageviewapi.per_article('en.wikipedia', 'Convict cichlid', '20000101', '20191120',
